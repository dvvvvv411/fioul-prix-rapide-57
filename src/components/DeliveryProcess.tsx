  ...
  const steps = [
    {
      icon: Calendar,
      title: "Planification",
      description: "Nous planifions votre livraison selon vos disponibilités",
      step: "1"
    },
    {
      icon: Truck,
      title: "Transport",
      description: "Livraison par camion-citerne professionnel avec suivi GPS",
      step: "2"
    },
    {
      icon: CheckCircle,
      title: "Réception",
      description: "Livraison sécurisée directement dans votre cuve",
      step: "3"
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Une livraison organisée en 3 étapes simples et sécurisées
          </p>
        </div>
