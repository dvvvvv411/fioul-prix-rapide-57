      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sélectionnez le combustible qui s'adapte idéalement à vos exigences et à votre budget
          </p>
        </div>
          ...
          <Card className="relative hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white via-blue-50/30 to-white border-2 border-blue-100/50 hover:border-blue-200 group hover:scale-105">
            <CardHeader className="text-center pb-6 relative">
              ...
              <div className="relative z-10">
                ...
                <CardTitle className="text-2xl font-bold text-gray-900 mb-2">Fuel Économique</CardTitle>
            ...
            <CardContent className="relative z-10">
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 p-3 bg-blue-50/50 rounded-lg">
                  ...
                  <span className="text-gray-700 font-medium">Rapport coût-efficacité idéal</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-blue-50/50 rounded-lg">
                  <Check className="text-success-green" size={18} />
                  <span className="text-gray-700 font-medium">Respectueux des standards hexagonaux</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-blue-50/50 rounded-lg">
                  <Check className="text-success-green" size={18} />
                  <span className="text-gray-700 font-medium">Acheminement express et sûr</span>
                </div>
              </div>
              <Button 
          ...
          <Card className="relative hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white via-red-50/30 to-white border-2 border-total-red hover:border-red-600 group hover:scale-105">
            ...
            <CardHeader className="text-center pb-6 pt-8 relative">
              ...
              <div className="relative z-10">
                ...
                <CardTitle className="text-2xl font-bold text-gray-900 mb-2">Combustible Haut de Gamme</CardTitle>
                ...
                <p className="text-gray-600 text-sm bg-red-50 px-4 py-2 rounded-full inline-block">
                  Amélioré avec composants haut de gamme
                </p>
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 p-3 bg-red-50/50 rounded-lg">
                  <Check className="text-success-green" size={18} />
                  <span className="text-gray-700 font-medium">Rendement maximisé</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-red-50/50 rounded-lg">
                  <Check className="text-success-green" size={18} />
                  <span className="text-gray-700 font-medium">Composants anti-rouille</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-red-50/50 rounded-lg">
                  <Check className="text-success-green" size={18} />
                  <span className="text-gray-700 font-medium">Sauvegarde équipement</span>
                </div>
              </div>
              <Button 
                onClick={handleGoToLanding}
