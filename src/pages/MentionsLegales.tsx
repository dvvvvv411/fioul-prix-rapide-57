          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <p><strong>Site web :</strong> <a href="https://fioulenergie.fr" className="text-blue-600 hover:underline">https://fioulenergie.fr</a></p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Si vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir le signaler par email, à l'adresse info@fioulenergie.fr, en décrivant le problème de la manière la plus précise possible.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Tout litige en relation avec l'utilisation du site https://fioulenergie.fr est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de Paris.
              </p>
            </section>
          </div>
        </div>
